<template>
    <div class="xp-displayer-wrapper">
		<div class="left-bar-wrapper"/>
		<div class="left-bar-separator"/>
		<div class="info-container">
			<div class="menu-title">
				<text>XP = 365173728</text>
			</div>
		</div>
	</div>
</template>
